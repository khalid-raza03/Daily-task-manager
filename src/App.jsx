...
function App() {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center transition-all duration-300 ease-in-out justify-start pt-0 ${darkMode ? 'bg-[#0f172a]' : 'bg-[#c3bbef]'}  `}>
      <Navbar darkMode={darkMode} setDarkMode={setDarkMode} />
      <EditableTodoList darkMode={darkMode} />
      
      <div className="text-center text-xs sm:text-md text-[#1E40AF] mt-10 fixed bottom-8 bg-white rounded-2xl px-6 py-2">
